...
spfq_codenames = [
    ...
    if c
    not in [
        "meta_spfq.add_spfqlist",
        "meta_spfq.change_spfqlist",
        "meta_spfq.delete_spfqlist",
        "meta_spfq.add_spfqforwithdrawallist",
        "meta_spfq.change_spfqforwithdrawallist",
        "meta_spfq.delete_spfqforwithdrawallist",
    ]
]
