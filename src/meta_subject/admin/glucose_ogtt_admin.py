...
from ..forms import GlucoseOgttForm
from ..models import GlucoseOgtt
from .list_filters import OgttListFilter
from .modeladmin import CrfModelAdminMixin


@admin.register(GlucoseOgtt, site=meta_subject_admin)
class GlucoseOgttAdmin(CrfModelAdminMixin, SimpleHistoryAdmin):
    form = GlucoseOgttForm
