...
crfs_prn = CrfCollection(
    ...
    Crf(show_order=227, model="meta_subject.glucoseogtt", required=False),
...
crfs_unscheduled = CrfCollection(
    ...
    Crf(show_order=410, model="meta_subject.glucoseogtt", required=False),
    name="unscheduled",
)
...
crfs_d1 = CrfCollection(
    ...
    Crf(show_order=200, model="meta_subject.glucoseogtt", required=False),
...
crfs_w2 = CrfCollection(
    ...
    Crf(show_order=210, model="meta_subject.glucoseogtt", required=False),
...
crfs_3m = CrfCollection(
    ...
    Crf(show_order=155, model="meta_subject.glucose", required=False),
    Crf(show_order=200, model="meta_subject.glucosefbg"),
    Crf(show_order=208, model="meta_subject.glucoseogtt", required=False),
...
crfs_18m = CrfCollection(
    ...
    Crf(show_order=222, model="meta_subject.bloodresultsrft", required=False),
    Crf(show_order=224, model="meta_subject.bloodresultslft", required=False),
    Crf(show_order=226, model="meta_subject.bloodresultslipids", required=False),
    Crf(show_order=300, model="meta_subject.studymedication"),
    Crf(show_order=310, model="meta_subject.medicationadherence"),
    Crf(show_order=320, model="meta_subject.hivexitreview", required=False),
    Crf(show_order=460, model="meta_subject.eq5d3l", required=False),
