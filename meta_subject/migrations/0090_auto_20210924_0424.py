...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'get_latest_by': 'history_date', 'ordering': ('-history_date', '-history_id'), 'verbose_name': 'historical Study Medication'},
        ),
        migrations.AlterModelOptions(
            name='studymedication',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Study Medication', 'verbose_name_plural': 'Study Medication'},
        ),
        ...
        migrations.AddIndex(
            model_name='studymedication',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_4198c4_idx'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='concomitantmedication',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_7479b1_idx'),
        ),
    ]
