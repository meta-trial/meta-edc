...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_bf5a26_idx'),
        ),
        migrations.AddIndex(
            model_name='additionalscreening',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_f7560d_idx'),
        ),
    ]
