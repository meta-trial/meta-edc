...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('meta_subject', '0097_auto_20220304_2233'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assay_date', models.DateTimeField(blank=True, null=True, verbose_name='Urine βhCG date')),
                ('bhcg_value', models.CharField(choices=[('POS', 'Positive'), ('NEG', 'Negative'), ('IND', 'Indeterminate')], max_length=25, verbose_name='Urine βhCG result')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_11189d_idx'),
        ),
    ]
