...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='bloodresultsins',
            name='ins_value',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(999.0)], verbose_name='Insulin'),
        ),
        migrations.AlterField(
            model_name='bloodresultslft',
            name='alp_units',
