...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('N/A', 'Not applicable'), ('4', 'Yes, grade 4'), ('3', 'Yes, grade 3'), ('2', 'Yes, grade 2'), ('1', 'Yes, grade 1'), ('No', 'Not reportable'), ('Already reported', 'Already reported'), ('present_at_baseline', 'Present at baseline')], max_length=25, null=True, verbose_name='reportable'),
        ),
        migrations.AlterField(
            model_name='bloodresultsfbc',
            name='hct_reportable',
