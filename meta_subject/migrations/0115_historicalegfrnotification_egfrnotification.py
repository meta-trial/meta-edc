    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creatinine_value', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Creatinine <u>level</u>')),
                ('creatinine_units', models.CharField(choices=[('mg/dL', 'mg/dL'), ('umol/L', 'μmol/L (micromoles/L)'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Units (creatinine)')),
                ...
                ('egfr_percent_change', models.DecimalField(blank=True, decimal_places=2, help_text='Copy from RFT result in the eGFR section', max_digits=10, null=True, verbose_name='Percent change from baseline')),
