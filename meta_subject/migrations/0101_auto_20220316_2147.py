    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('informant_is_patient', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=5, verbose_name='Was this information from study participant?')),
                ('informant_contact', django_crypto_fields.fields.encrypted_text_field.EncryptedTextField(blank=True, help_text=' (Encryption: AES local)', max_length=71, null=True, verbose_name='If information not from study participant, please give the name and contact details of the informant.')),
                ('informant_relation', models.CharField(blank=True, choices=[('husband_wife', 'Husband/wife'), ('Parent', 'Parent'), ('child', 'Child'), ('unknown', 'Unknown'), ('OTHER', 'Other')], max_length=25, null=True, verbose_name='Informants relationship to the participant?')),
                ('informant_relation_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('delivery_datetime', models.DateTimeField(help_text='If TIME unknown, estimate', validators=[edc_model.models.validators.date.datetime_not_future, edc_protocol.validators.datetime_not_before_study_start], verbose_name='Date and time of delivery :')),
                ('delivery_time_estimated', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Is the delivery TIME estimated?')),
                ('delivery_location', models.CharField(choices=[('home', 'At home'), ('hospital_clinic', 'Hospital / Clinic'), ('OTHER', 'Other location, specify')], max_length=25, verbose_name='Where did the delivery occur?')),
                ('delivery_location_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('delivery_location_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='If delivery occurred at a `hospital` or `clinic`, please give name of the facility')),
                ('delivery_ga', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(45)], verbose_name='Gestational age at delivery')),
                ('maternal_outcome', models.CharField(choices=[('no_complications', 'No complications'), ('complications_full_recovery', 'Complications with full recovery'), ('complications_ongoing_recovery', 'Complications with ongoing recovery'), ('dead', 'Maternal mortality')], max_length=50, verbose_name='What was the maternal outcome of the pregnancy?')),
                ('gm_treated', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=5, verbose_name='Was the participant treated for gestational diabetes?')),
                ('fetal_outcome_count', models.IntegerField(help_text='Each to be reported individually below', verbose_name='Number of births / fetal / neonatal outcomes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, verbose_name='Report Date and Time')),
                ('contact', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If yes, please specify below', max_length=15, verbose_name='Has the clinic received any updates on this pregnancy?')),
                ('comment', models.TextField(null=True, verbose_name='Comment / Updates')),
                ('pregnancy_notification', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='meta_prn.pregnancynotification')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='meta_subject.subjectvisit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pregnancy_notification', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_prn.pregnancynotification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_outcome', models.CharField(choices=[('live_at_term', 'Live birth at term'), ('live_preterm', 'Live birth preterm'), ('stillbirth', 'Stillbirth'), ('miscarriage', 'Miscarriage')], max_length=25, verbose_name='Outcome')),
                ('birth_weight', models.IntegerField(blank=True, help_text='gm', null=True, verbose_name='Weight (gm)')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('delivery', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_subject.delivery')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_weight', models.IntegerField(blank=True, help_text='gm', null=True, verbose_name='Weight (gm)')),
                ('action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.actionitem')),
                ('delivery', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='meta_subject.delivery')),
                ('parent_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='meta_subject.subjectvisit')),
