...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('meta_subject', '0062_auto_20210713_0616'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(choices=[('atorvastatin', 'Atorvastatin'), ('rosuvastatin', 'Rosuvastatin'), ('none', 'Not taking any medication'), ('N/A', 'Not applicable')], default='PHASE_THREE_ONLY', max_length=25, verbose_name='What medication is the patient currently taking for dyslipidaemia?'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hbsag_performed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Was Hepatitis B Surface Antigen test performed?')),
                ('hbsag', models.CharField(blank=True, choices=[('POS', 'Positive'), ('NEG', 'Negative'), ('not_done', 'Not done')], max_length=15, null=True, verbose_name='<u>HbSAg</u>')),
                ('hbsag_date', models.DateField(blank=True, null=True, validators=[edc_model.models.validators.date.date_is_past, edc_model.models.validators.date.date_is_not_now], verbose_name='<i>HbSAg date</i>')),
                ('hcv_performed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Was the patient tested for Hepatitis C?')),
                ('hcv', models.CharField(blank=True, choices=[('POS', 'Positive'), ('NEG', 'Negative'), ('not_done', 'Not done')], max_length=15, null=True, verbose_name='<u>HCV</u>')),
                ('hcv_date', models.DateField(blank=True, null=True, validators=[edc_model.models.validators.date.date_is_past, edc_model.models.validators.date.date_is_not_now], verbose_name='<i>HCV date</i>')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_424a4b_idx'),
        ),
    ]
