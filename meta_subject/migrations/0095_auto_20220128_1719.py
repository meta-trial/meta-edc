    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diet_and_lifestyle', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='This response is not criteria for eligibility', max_length=15, null=True, verbose_name='Has the participant received the META3 approved diet and lifetsyle counseling?')),
                ('diet_and_lifestyle_duration', models.IntegerField(help_text='Report in minutes. This response is not criteria for eligibility', null=True, verbose_name='How much time was spent on the META3 approved diet and lifetsyle counseling with the patient?')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='meta_subjec_subject_0c33b8_idx'),
        ),
    ]
