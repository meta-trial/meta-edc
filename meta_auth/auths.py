...
from edc_listboard.auth_objects import LISTBOARD
...
site_auths.update_role(LISTBOARD, name=DATA_MANAGER_ROLE)
site_auths.update_role(LISTBOARD, ACTION_ITEM, UNBLINDING_REQUESTORS, name=TMG_ROLE)
