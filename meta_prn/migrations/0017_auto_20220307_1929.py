...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='losstofollowup',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Loss to Follow Up', 'verbose_name_plural': 'Loss to Follow Up'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maternal_outcome', models.CharField(choices=[('no_complications', 'No complications'), ('complications_full_recovery', 'Complications with full recovery'), ('complications_ongoing_recovery', 'Complications with ongoing recovery'), ('maternal_mortality', 'Maternal mortality')], max_length=50, verbose_name='What was the maternal outcome of the pregnancy?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', django_audit_fields.fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('maternal_identifier', models.CharField(editable=False, max_length=50)),
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, verbose_name='Report Date and Time')),
                ...
                ('delivery', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='meta_prn.delivery')),
            ],
            options={
